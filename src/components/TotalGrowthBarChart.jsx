...
import './TotalGrowthBarChart.css'
...
const renderLegend = () => (
  <Box className="growth-chart__legend">
    {[
      ...
      <Box key={item.key} className="growth-chart__legend-item">
        <Box
...
export default function TotalGrowthBarChart() {
  return (
    <Card className="growth-chart">
      <CardContent className="growth-chart__content">
        <Box className="growth-chart__header">
          <Box>
            <Typography variant="body2" color="text.secondary">
              Total Growth
            </Typography>
            <Typography variant="h4" className="growth-chart__amount">
              $2,324.00
            </Typography>
          </Box>
          <Box className="growth-chart__controls">
            <Select size="small" defaultValue="today" className="growth-chart__select">
